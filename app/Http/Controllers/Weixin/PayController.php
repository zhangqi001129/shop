...
class PayController extends Controller
{
    ...
    public $weixin_notify_url = 'http://http://zq.lixiaonitongxue.top/weixin/pay/notice';     //支付通知回调
    ...
    public function test($order_id)
    {
        ...
        $orderInfo=OrderModel::where(['oid'=>$order_id])->first();
        $order_info = [
